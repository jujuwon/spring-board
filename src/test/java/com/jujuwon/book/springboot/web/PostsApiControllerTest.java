...
import com.jujuwon.book.springboot.web.dto.PostsUpdateRequestDto;
...
// WebMvcTest 는 JPA 기능이 작동하지 않기 때문에 JPA 기능까지 테스트할 때는 SpringBootTest + TestRestTemplate 사용
public class PostsApiControllerTest {
    ...
    public void BaseTimeEntity_registration() {
        ...
        System.out.println(">>>>>>>>>> createDate=" + posts.getContent() + ", " +
